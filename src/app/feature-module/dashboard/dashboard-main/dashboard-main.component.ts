...
export class DashboardMainComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private _statistics: DashboardStatisticsService,
  ) {}
  ngOnInit(): void {
    this.statisticsCall();
    this.getInHandCases();
    this.getInHandPrizes();
  }
  ...
  getInHandCases(){
    this.inHandCases= [
      {
          "id": 5,
          "createdDate": "2024-02-06T16:55:28",
          "modifiedDate": "2024-02-16T17:25:14",
          "uuid": "a9b45f9b-e457-4091-bd95-bc29bfe30779",
          "name": "Izaldeen Ashour",
          "contractUUID": "bd1812b8-acd0-4517-b845-5bfe478068aa",
          "offerUUID": "1bbf80cc-b3df-4fd2-bbcf-57dfe9197a1c",
          "caseAbstract": "<p><span style=\"color: rgb(126, 130, 153);\">Case Abstract should be at least 13 characters long.</span></p>",
          "budget": 2222.00,
          ...
          "paymentPlanning": [
              {
                  "id": 7,
                  "caseUUID": "a9b45f9b-e457-4091-bd95-bc29bfe30779",
  ...
  this.inHandPrizes= [
    {
        "id": 1,
        "createdDate": "2024-02-07T17:57:44",
        "modifiedDate": "2024-02-07T17:58:06",
        "name": "Poppy",
        "uuid": "736b1e4a-1b64-4cf4-a75b-29161c898b4f",
        "prizeAbstract": "<ul><li><span style=\"color: rgb(7, 120, 185);\">Prize Description</span></li><li><span style=\"color: rgb(7, 120, 185);\">Prize Description</span></li><li><span style=\"color: rgb(7, 120, 185);\">Prize Description</span></li><li><span style=\"color: rgb(7, 120, 185);\">Prize Description</span></li><li><span style=\"color: rgb(7, 120, 185);\"><span class=\"ql-cursor\">﻿</span>Prize Description</span></li></ul>",
        "requirements": "Prize Description",
        "amount": 10000.0,
        "announcementDate": "2024-02-23",
        "submissionEndDate": "2024-02-17",
        "status": "PUBLISHED",
        "judges": "Prize Description",
        "deliveryMethod": "UPLOAD",
        "deliveryInfo": "none",
        "publicPrize": true,
        "limited": true,
        "allowedParticipantNumber": 1,
        "participantsNumber": 1,
        "externalUrl": "",
        "ownerParticipant": {
            "id": 2,
            "fullName": "zid systems",
            "instituteName": "Ubi Soft",
            "country": "Germany",
            "city": null,
            "continent": "Europe",
            ...
            "userDto": {
                ...
                "status": "ACTIVE",
                "isEnabled": true,
                "creationDate": "2024-02-06T10:09:55",
  ...
  statisticsCall() {
    this.loader=true
  this._statistics.getUserStatistics()
  ...
  // render some markup from the parent to the child ng-content
