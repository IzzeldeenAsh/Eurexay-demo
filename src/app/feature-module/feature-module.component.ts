import { Component, ViewEncapsulation, HostListener, NgZone, OnDestroy, OnInit, ViewChild, ElementRef } from '@angular/core';
import { ActivatedRoute, NavigationEnd, Router } from '@angular/router';
import { DataService ,SideBar, SideBarMenu} from '../core/core.index';
import { SideBarService } from '../core/services/side-bar/side-bar.service';
import { Location } from '@angular/common';
import { LayoutInitService } from '../core/services/layout/layout-init.service';
import { LayoutService } from '../core/services/layout/layout.service';
import { IUser } from '../core/models/userInfo.interface';
import { NotificationsService } from '../core/services/notifications/notifications.service';
import { Subject, take, takeUntil } from 'rxjs';
import { SharedService } from '../core/services/shared/shared.service';
import { UserInfoService } from '../core/services/user-info/user-info.service';
import { AlertsService } from '../core/services/alert/alerts.service';
import { INotifiactions } from '../core/models/noticiations';
import { animate, state, style, transition, trigger } from '@angular/animations';
import { CurrentUserService } from '../core/services/user-info/current-user.service';
const dummy = {
  "status": {
      "code": "0",
      "description": "Success",
...
export class FeatureModuleComponent implements  OnInit, OnDestroy {
 ...
 getUserInfo() {
  this.userDataInfo = dummy.result;
    this.username = dummy.result.username
  }
  getRoutes(event:routerlink){
    ...
    ngOnInit(): void {
      ...
      this._sharedService.showNotification$.subscribe((data)=>{
    ...
    getUserNotifications(){
      this._notifications.getNotificaitons().pipe(takeUntil(this.unsubscribe$))
      .subscribe({
        next: (data) => {
