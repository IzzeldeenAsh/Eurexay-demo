...
export class TopbarComponent implements OnInit ,OnDestroy {
 ...
 @HostListener('document:click',['$event'])
  ...
  ngOnInit(): void {
   ...
   this._sharedService.updateTopbarNotification$.subscribe(data=>this.getNotifications())
  ...
  getUserInfo(){
    this.imageProfile = dummy.result.profilePicBase64;
  ...
  toggleNotifications(event:Event) {
    ...
    this._sharedService.showNotification$.subscribe(data=>this.showNotifications = data)
    this._sharedService.setShowNotification(!this.showNotifications)
  }
